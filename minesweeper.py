...
class Sentence():
    ...
    def known_mines(self):
        ...
        # If count is equal to the length of set of cells 
        # then it is clear that all the cells are mines
        # If not then there are 0 known mines
    ...
    def mark_mine(self, cell):
        ...
        # First checks to see if cell is in self.cells
        # Then goes onto remove cell from the set and also
        # updates the count i.e no. of mines
    ...
    def mark_safe(self, cell):
        ...
        # First checks to see if cell is in self.cells
        # Then goes onto remove cell from the set
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Marks the cell as one of the moves made in the game
        self.moves_made.add(cell)

        # Marks the cell as a safe cell
        self.mark_safe(cell)

        # new_cells keeps track of neighbouring cells
        # who's state is still undetermined
        new_cells = set()
        
        
        # Loop through neighbouring cells 
        # to add a sentence that indicates
        # count of the cell's neighbours are mines
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # Add cell if it's within the bounds
                # of the game board
                if 0 <= i < self.height and 0 <= j < self.width:
                    new_cells.add((i, j))
        ...
        # Based off sentences in self.knowledge
        # mark new cells as safe or mine (if possible)

        # Mark all known safes and mines
        # Add them to self.safes and self.mines
        # Updating knowledge iteratively in order to use
        # the new sentence(s) to further update the KB
    ...
    def make_random_move(self):
        ...
        random_move = random.choice(list(moves))
